...
# Crear el dataset para aplicar manova

data1_victory$winner <- rep(1,86636)
data1_defeat$winner <- rep(0,86636)

data_all = merge(data1_victory, data1_defeat, all = TRUE)

# -------------------------------- PRUEBA MANOVA -------------------------------------

dependent_vars <- cbind(data_all$winner_gold, data_all$loser_gold, data_all$Player_1_pick, data_all$Player_1_gold, data_all$Player_1_xp, data_all$Player_1_dmg_dealt, data_all$Player_1_dmg_taken, data_all$Player_1_time_ccing, data_all$Player_2_pick, data_all$Player_2_gold, data_all$Player_2_xp, data_all$Player_2_dmg_dealt, data_all$Player_2_dmg_taken, data_all$Player_2_time_ccing,
                        data_all$Player_3_pick, data_all$Player_3_gold, data_all$Player_3_xp, data_all$Player_3_dmg_dealt, data_all$Player_3_dmg_taken, data_all$Player_3_time_ccing, data_all$Player_4_pick,
                        data_all$Player_4_gold, data_all$Player_4_xp, data_all$Player_4_dmg_dealt, data_all$Player_4_dmg_taken, data_all$Player_4_time_ccing, data_all$Player_5_pick, data_all$Player_5_gold,
                        data_all$Player_5_xp, data_all$Player_5_dmg_dealt, data_all$Player_5_dmg_taken, data_all$Player_5_time_ccing)

independent_var <- data_all$winner

manova_model <- manova(dependent_vars ~ independent_var, data = data_all)
summary(manova_model)

model_lda <- lda(independent_var ~ dependent_vars, CV = F)
